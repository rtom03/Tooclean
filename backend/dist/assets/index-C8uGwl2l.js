    ...
    function $(e, t, n, r, a, o) {
      switch (n) {
        ...
        case `popover`:
          ...
          break;
        case `xlinkActuate`:
          A(e, `http://www.w3.org/1999/xlink`, `xlink:actuate`, r);
          break;
        case `xlinkArcrole`:
          A(e, `http://www.w3.org/1999/xlink`, `xlink:arcrole`, r);
          break;
        case `xlinkRole`:
          A(e, `http://www.w3.org/1999/xlink`, `xlink:role`, r);
          break;
        case `xlinkShow`:
          A(e, `http://www.w3.org/1999/xlink`, `xlink:show`, r);
          break;
        case `xlinkTitle`:
          A(e, `http://www.w3.org/1999/xlink`, `xlink:title`, r);
          break;
        case `xlinkType`:
          A(e, `http://www.w3.org/1999/xlink`, `xlink:type`, r);
          break;
        case `xmlBase`:
          A(e, `http://www.w3.org/XML/1998/namespace`, `xml:base`, r);
          break;
        case `xmlLang`:
          A(e, `http://www.w3.org/XML/1998/namespace`, `xml:lang`, r);
          break;
        case `xmlSpace`:
          A(e, `http://www.w3.org/XML/1998/namespace`, `xml:space`, r);
          break;
        case `is`:
          Lt(e, `is`, r);
          break;
...
var Ke = _.createContext(!1);
function qe() {
  return _.useContext(Ke);
}
var Je = _.createContext({ isTransitioning: !1 });
Je.displayName = `ViewTransition`;
var Ye = _.createContext(new Map());
...
function ot(e, { relative: t } = {}) {
  ...
  let { basename: n, navigator: r } = _.useContext(Ze),
    { hash: i, pathname: a, search: o } = k(e, { relative: t }),
    s = a;
  return (
    n !== `/` && (s = a === `/` ? n : Ne([n, a])),
...
function dt() {
  let { isDataRoute: e } = _.useContext($e);
  return e ? Pt() : ft();
}
function ft() {
  w(
...
function mt(e) {
  let t = _.useContext($e).outlet;
  return _.useMemo(
    () => t && _.createElement(pt.Provider, { value: e }, t),
    [t, e],
  );
}
function ht() {
  let { matches: e } = _.useContext($e),
    t = e[e.length - 1];
  return t ? t.params : {};
}
function k(e, { relative: t } = {}) {
  let { matches: n } = _.useContext($e),
    { pathname: r } = ct(),
...
function _t(e, t, n) {
  ...
  let { navigator: r } = _.useContext(Ze),
    { matches: i } = _.useContext($e),
    a = i[i.length - 1],
    o = a ? a.params : {},
    s = a ? a.pathname : `/`,
    c = a ? a.pathnameBase : `/`,
...
var yt = _.createElement(vt, null),
  bt = class extends _.Component {
    constructor(e) {
      (super(e),
        (this.state = {
          location: e.location,
      ...
      let t =
        e === void 0
          ...
          : _.createElement(
              ...
              _.createElement(et.Provider, {
                value: e,
                children: this.props.component,
              }),
            );
      return this.context ? _.createElement(St, { error: e }, t) : t;
    }
  };
bt.contextType = Ke;
var xt = new WeakMap();
...
function Ct({ routeContext: e, match: t, children: n }) {
  ...
  return (
    ...
    _.createElement($e.Provider, { value: e }, n)
  );
}
function wt(e, t = [], n) {
  let r = n?.state;
...
function jt() {
  return Dt(`useNavigation`).navigation;
}
function Mt() {
...
(_.useOptimistic, _.memo(Lt));
function Lt({ routes: e, future: t, state: n, isStatic: r, onError: i }) {
  return _t(e, void 0, { state: n, isStatic: r, onError: i, future: t });
}
function Rt(e) {
  return mt(e.context);
}
...
var An = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  jn = _.forwardRef(function (
    ...
    let {
      ...
      b = Ve(l, h);
    l = b.to;
    let x = ot(l, { relative: r }),
      ee = ct(),
      S = null;
    if (o) {
      let e = Me(o, [], ee.unstable_mask ? ee.unstable_mask.pathname : `/`, !0);
    ...
    return C && !y
      ? _.createElement(_.Fragment, null, ie, _.createElement(Sn, { page: x }))
      : ie;
  });
jn.displayName = `Link`;
...
var Nn = _.forwardRef(
  (
    ...
    let { unstable_useTransitions: h } = _.useContext(Ze),
      g = Vn(),
      v = Hn(s, { relative: l }),
...
function Pn({ getKey: e, storageKey: t, ...n }) {
  ...
  return _.createElement(`script`, {
    ...
    dangerouslySetInnerHTML: {
      __html: `(${c})(${rn(JSON.stringify(t || Un))}, ${rn(JSON.stringify(s))})`,
    },
  });
}
...
function Vn() {
  ...
  return _.useCallback(
    async (e, a = {}) => {
      ...
      a.navigate === !1
        ? await r(a.fetcherKey || Bn(), n, a.action || o, {
...
var Yn = o((e) => {
  ...
  Zn = () => {
    ...
    return (
      ...
      (0, j.jsx)(`div`, {
        className: `overflow-hidden bg-[#453224] text-white py-2.5 select-none`,
        children: (0, j.jsx)(`div`, {
          ref: e,
          className: `flex whitespace-nowrap will-change-transform`,
          children: [...Xn, ...Xn].map((e, t) =>
            (0, j.jsxs)(
              `span`,
              {
  ...
  Qn = (...e) =>
    e
      ...
      .join(` `)
      .trim(),
  $n = (e) => e.replace(/([a-z0-9])([A-Z])/g, `$1-$2`).toLowerCase(),
  er = (e) =>
  ...
  sr = (e, t) => {
    let n = (0, _.forwardRef)(({ className: n, ...r }, i) =>
      (0, _.createElement)(or, {
        ref: i,
        iconNode: t,
        className: Qn(`lucide-${$n(tr(e))}`, `lucide-${e}`, n),
        ...r,
      }),
    );
  ...
  lr = sr(`chevron-down`, [[`path`, { d: `m6 9 6 6 6-6`, key: `qrunsl` }]]),
  ur = sr(`chevron-left`, [[`path`, { d: `m15 18-6-6 6-6`, key: `1wnfg3` }]]),
  dr = sr(`chevron-right`, [[`path`, { d: `m9 18 6-6-6-6`, key: `mthhwq` }]]),
  fr = sr(`eye-off`, [
    [
      `path`,
      {
  ...
  yr = [`Black Hairline Spray`, `Brown Hairline Spray`],
  br = () => {
    ...
    return (
      ...
      (0, j.jsxs)(j.Fragment, {
        children: [
          (0, j.jsxs)(`header`, {
            className: `sticky top-0 z-50 bg-[#1a1a1a] border-b border-white/8 h-16 flex items-center justify-between px-5 md:px-7`,
            children: [
              (0, j.jsx)(`button`, {
              ...
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  (0, j.jsx)(`div`, {
                    className: `w-12 h-12 bg-white flex items-center justify-center rounded-sm mr-4 shrink-0`,
                    children: (0, j.jsx)(jn, {
                      to: `/`,
                        ...
                        children: [
                          (0, j.jsxs)(`button`, {
                            ...
                            children: [
                              ...
                              (0, j.jsx)(lr, {
                                size: 12,
                                className: `transition-transform duration-200 ${e ? `rotate-180` : ``}`,
                              }),
                            ],
                          }),
                          e &&
                            (0, j.jsx)(`div`, {
                              className: `absolute top-16 left-0 bg-[#1a1a1a] border border-t-0 border-white/10 min-w-[180px] py-2 z-50`,
                              children: yr.map((e) =>
                                (0, j.jsx)(
                                  jn,
                                  {
              ...
              (0, j.jsx)(jn, {
                ...
                children: (0, j.jsx)(`div`, {
                  className: `w-10 h-10 bg-white flex items-center justify-center rounded-sm`,
                  children: (0, j.jsx)(`img`, {
                    src: `/Tooclean.jpg`,
                    alt: `logo`,
                  }),
              ...
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  (0, j.jsxs)(`button`, {
                    className: `hidden md:flex items-center gap-1.5 text-[#d1d5db] text-[13px] hover:text-white transition-colors`,
                    children: [`Nigeria | NGN`, (0, j.jsx)(lr, { size: 12 })],
                  }),
                  (0, j.jsx)(`span`, {
                    className: `hidden md:block text-white/20 text-sm mx-1`,
                    children: `|`,
                  }),
                  (0, j.jsx)(`button`, {
                    className: `text-white hover:opacity-70 transition-opacity md:ml-2`,
                    children: (0, j.jsx)(_r, { size: 22, strokeWidth: 1.8 }),
                  }),
                ],
              }),
            ],
          ...
          n &&
            (0, j.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, j.jsx)(`div`, {
                  className: `relative w-72 max-w-[80vw] bg-[#1a1a1a] h-full flex flex-col z-50 overflow-y-auto`,
                    ...
                    children: [
                      (0, j.jsxs)(`div`, {
                        children: [
                          ...
                          e &&
                            (0, j.jsx)(`div`, {
                              className: `flex flex-col pl-4 py-2 gap-1`,
                              children: yr.map((e) =>
                                (0, j.jsx)(
                                  jn,
                                  {
                      ...
                      (0, j.jsxs)(`button`, {
                        className: `flex items-center gap-2 text-[#d1d5db] text-[12px] uppercase tracking-wide py-4 mt-4 hover:text-white transition-colors`,
                        children: [
                          `United States | USD $`,
                          (0, j.jsx)(lr, { size: 12 }),
                        ],
  ...
  Cr = () => {
    ...
    return (0, j.jsxs)(`footer`, {
      className: `bg-[#453224] px-7 pt-16 pb-8 flex flex-col items-center`,
      children: [
        (0, j.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, j.jsx)(`p`, {
              className: `text-[14px] text-white/60 max-w-md leading-relaxed mb-7`,
              children: `Sign up for our emails to receive special offers, expert hair styling advice, and the latest updates.`,
            }),
            (0, j.jsxs)(`div`, {
              className: `flex items-center border border-white/30 rounded-full px-5 py-1.5 max-w-sm w-full mx-auto gap-2`,
              children: [
                (0, j.jsx)(`input`, {
                  type: `email`,
                  value: e,
                ...
                (0, j.jsx)(`button`, {
                  className: `w-9 h-9 bg-white rounded-full flex items-center justify-center flex-shrink-0 hover:bg-white/90 transition-colors`,
                  children: (0, j.jsx)(cr, {
                    size: 15,
                    className: `text-[#453224]`,
                  }),
                }),
              ],
            }),
        ...
        (0, j.jsx)(`div`, {
          className: `w-full max-w-2xl h-px bg-white/10 mb-9`,
        }),
        (0, j.jsx)(`nav`, {
          className: `flex flex-wrap justify-center gap-x-6 gap-y-2.5 mb-3`,
          children: xr.map((e) =>
            (0, j.jsx)(
              `a`,
              {
  ...
  wr = () =>
    (0, j.jsxs)(`div`, {
      ...
      children: [
        (0, j.jsx)(Zn, {}),
        (0, j.jsx)(br, {}),
        (0, j.jsx)(`main`, { className: ``, children: (0, j.jsx)(Rt, {}) }),
        (0, j.jsx)(Cr, {}),
      ],
    }),
  Tr = () =>
    (0, j.jsx)(`section`, {
      className: `w-full h-[40vh] md:h-[92vh] overflow-hidden bg-[#FBF6F0]`,
      children: (0, j.jsx)(`img`, {
        src: `/hero.png`,
        alt: `Too Clean Hair Line Spray`,
        className: `w-full h-full object-contain`,
      }),
    }),
  Er = `/api`,
  Dr = async () => {
    let e = await fetch(`${Er}/products`, {
      method: `GET`,
      credentials: `include`,
    });
    if (!e.ok) throw Error(`Error fetching data`);
    return await e.json();
  },
  Or = async (e) => {
    let t = await fetch(`${Er}/products/${e}`, {
      method: `GET`,
      credentials: `include`,
    });
    if (!t.ok) throw Error(`Error fetching data`);
    return await t.json();
  },
  kr = async (e) => {
    let t = await fetch(`${Er}/order/create-order-data`, {
      method: `POST`,
  ...
  Ar = async (e) => {
    let t = await fetch(`${Er}/order/order-data/${e}`);
    if (!t.ok) throw Error(`Error fetching data`);
    return await t.json();
  },
  jr = () => {
    ...
    return (
      ...
      (0, j.jsxs)(`section`, {
        className: `w-full px-7 py-5 flex flex-col items-center bg-[#453224]`,
        children: [
          (0, j.jsx)(`h1`, {
            className: `text-5xl font-bold text-[#FBF6F0] text-center tracking-tight mb-12`,
            children: `SHOP HERE`,
          }),
          (0, j.jsx)(`div`, {
            className: `grid grid-cols-2 gap-4 w-full max-w-2xl text-[#FBF6F0]`,
            children: e.map((e) =>
              (0, j.jsxs)(
                jn,
                {
                  ...
                  children: [
                    (0, j.jsx)(`div`, {
                      className: `bg-[#453224] rounded-2xl overflow-hidden aspect-3/4`,
                      children: (0, j.jsx)(`img`, {
                        src: e.images[0],
                        alt: `Too Clean ${e.name}`,
                    ...
                    (0, j.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, j.jsxs)(`p`, {
                          ...
                          children: [`₦`, e.price.toLocaleString(`en-NG`)],
                        }),
                      ],
                    }),
                  ],
  ...
  Mr = () =>
    (0, j.jsxs)(`section`, {
      className: `w-full py-5 px-7 flex flex-col items-center bg-white`,
      children: [
        (0, j.jsx)(`h2`, {
          className: `text-3xl md:text-6xl font-black text-[#1a1a1a] text-center tracking-tight leading-none mb-12`,
          ...
          children: [
            ...
            (0, j.jsxs)(
              `div`,
              {
                ...
                children: [
                  (0, j.jsx)(`div`, {
                    className: `absolute -bottom-2 -right-2 w-3/5 h-3/5 bg-[#d4cfe8] rounded-sm -z-10`,
                  }),
                  (0, j.jsxs)(`div`, {
                    className: `relative aspect-3/4 rounded-sm overflow-hidden bg-[#e8e4f0]`,
                    children: [
                      (0, j.jsx)(`img`, {
                        src: t,
                        alt: e,
                      ...
                      (0, j.jsx)(`div`, {
                        className: `absolute inset-0 bg-linear-to-b from-transparent via-transparent to-black/40`,
                      }),
                      (0, j.jsx)(`span`, {
                        className: `absolute bottom-4 left-4 bg-white text-[#1a1a1a] text-[14px] font-extrabold px-4 py-1.5 rounded-sm`,
                        children: e,
                      }),
                    ],
                  }),
  ...
  Pr = { name: `Hairline Spray`, price: `$24.99` },
  Fr = ({ src: e }) => {
    let t = (0, _.useRef)(null);
    return (0, j.jsxs)(`div`, {
      onMouseEnter: () => t.current?.play(),
      onMouseLeave: () => {
      ...
      children: [
        ...
        (0, j.jsxs)(`div`, {
          className: `absolute bottom-3 left-3 right-3 flex items-center gap-2 bg-white/15 backdrop-blur-md rounded-xl px-2.5 py-2`,
          children: [
            (0, j.jsx)(`div`, {
              className: `w-7 h-7 rounded-lg bg-white flex-shrink-0 flex items-center justify-center`,
  ...
  Ir = () => {
    let e = (0, _.useRef)(null),
      ...
      a = (t) => {
        (n(!0),
          (r.current = t.pageX - e.current.offsetLeft),
          (i.current = e.current.scrollLeft));
      },
      o = (n) => {
        if (!t) return;
        n.preventDefault();
        let a = n.pageX - e.current.offsetLeft;
        e.current.scrollLeft = i.current - (a - r.current) * 1.5;
      },
      s = () => n(!1);
    return (0, j.jsxs)(`section`, {
      ...
      children: [
        (0, j.jsx)(`h2`, {
          className: `flex justify-center text-2xl font-extrabold text-white tracking-tight mb-10`,
          children: `INSTANT HAIRLINE IN SECONDS`,
        }),
        (0, j.jsx)(`div`, {
          ref: e,
          onMouseDown: a,
          ...
          children: Nr.map((e) => (0, j.jsx)(Fr, { src: e.src }, e.id)),
        }),
      ],
    });
  },
  ...
  Rr = ({ images: e }) => {
    ...
    return (
      ...
      (0, j.jsxs)(`div`, {
        className: `relative bg-[#F5EFE6] rounded-xl overflow-hidden aspect-square flex items-center justify-center group`,
        children: [
          (0, j.jsx)(`img`, { src: e[t], alt: `Product image ${t + 1}` }, t),
          (0, j.jsx)(`button`, {
            onClick: () => n((t) => (t === 0 ? e.length - 1 : t - 1)),
            ...
            children: (0, j.jsx)(ur, { size: 18, className: `text-[#1a1a1a]` }),
          }),
          (0, j.jsx)(`button`, {
            onClick: () => n((t) => (t === e.length - 1 ? 0 : t + 1)),
            ...
            children: (0, j.jsx)(dr, { size: 18, className: `text-[#1a1a1a]` }),
          }),
          (0, j.jsx)(`div`, {
            ...
            children: e.map((e, r) =>
              (0, j.jsx)(
                ...
                {
                  onClick: () => n(r),
                  className: `w-1.5 h-1.5 rounded-full transition-all ${r === t ? `bg-[#1a1a1a] w-3` : `bg-[#1a1a1a]/30`}`,
                },
                r,
              ),
            ),
  ...
  zr = (e) => [
    { qty: 1, label: `1 Bottle`, price: e, badge: `Free Shipping` },
    {
      qty: 3,
      label: `3 Bottles`,
      price: e * 3 - 1500,
  ...
  Br = () => {
    let [e, t] = (0, _.useState)(null),
      ...
      c = async () => {
        if ((o(!a), !e)) return;
        let t = u.find((e) => e.qty === n);
        if (t)
          try {
            let n = await kr({ productId: e.id, qty: t.qty });
            (o(a), s(`/check-out/${n.orderId}`));
          } catch (e) {
            console.error(e);
          }
      },
    ...
    let u = e ? zr(e.price) : [];
    return (0, j.jsxs)(`div`, {
      className: `max-w-5xl bg-[#F0E9DF] mx-auto px-7 py-12 grid grid-cols-1 md:grid-cols-2 gap-14`,
      children: [
        (0, j.jsx)(Rr, { images: e?.images ?? [] }),
        (0, j.jsxs)(`div`, {
          className: `flex flex-col pt-2`,
          children: [
            (0, j.jsx)(`p`, {
              className: `text-[10px] font-bold tracking-[0.14em] uppercase text-[#888] mb-2`,
              children: `Too Clean — Hair Products`,
            }),
            (0, j.jsx)(`h1`, {
              className: `text-4xl font-black text-[#1a1a1a] tracking-tight mb-7`,
              children: e?.name ?? `Hairline Spray`,
            }),
            (0, j.jsxs)(`div`, {
              className: `flex items-center gap-3 mb-2`,
              children: [
                (0, j.jsx)(`div`, {
                  className: `flex-1 h-[1.5px] bg-[#1a1a1a]`,
                }),
                (0, j.jsx)(`span`, {
                  className: `text-[11px] font-extrabold tracking-widest uppercase whitespace-nowrap`,
                  children: `We Made This Easy For You`,
                }),
                (0, j.jsx)(`div`, {
                  className: `flex-1 h-[1.5px] bg-[#1a1a1a]`,
                }),
            ...
            (0, j.jsx)(`p`, {
              className: `text-center text-[13px] text-[#666] italic mb-5`,
              children: `The more you buy, the more you save`,
            }),
            (0, j.jsx)(`div`, {
              ...
              children: u.map((t) =>
                ...
                ${n === t.qty ? `border-[#1a1a1a]` : `border-[#e0e0e0]`}`,
                    children: [
                      (0, j.jsx)(`div`, {
                        className: `absolute -top-3 right-3 bg-[#1a1a1a] text-white text-[9px] font-extrabold tracking-[0.08em] uppercase px-2.5 py-1 rounded whitespace-nowrap`,
                        children: t.badge,
                      }),
                      (0, j.jsx)(`div`, {
                        className: `w-[18px] h-[18px] rounded-full border-2 shrink-0 flex items-center justify-center transition-colors
                  ${n === t.qty ? `border-[#1a1a1a]` : `border-[#ccc]`}`,
                        children:
                          n === t.qty &&
                          (0, j.jsx)(`div`, {
                      ...
                      (0, j.jsxs)(`div`, {
                        ...
                        children: [
                          (0, j.jsx)(`img`, {
                            src: e?.images?.[0] ?? `/placeholder.jpg`,
                            alt: e?.name,
                            className: `w-10 h-10 object-contain`,
                          }),
                          (0, j.jsxs)(`div`, {
                            className: `absolute -bottom-1 -left-1 bg-[#1a1a1a] text-white text-[9px] font-extrabold w-[18px] h-[18px] rounded flex items-center justify-center`,
                            children: [`x`, t.qty],
                          }),
                        ],
                      }),
                        ...
                        children: [
                          ...
                          (0, j.jsx)(`div`, {
                            ...
                            children: (0, j.jsx)(`span`, {
                              className: `text-[11px] font-semibold text-[#1a7a3c]`,
                      ...
                      (0, j.jsx)(`div`, {
                        ...
                        children: (0, j.jsxs)(`p`, {
                          className: `text-[17px] font-extrabold text-[#1a7a3c]`,
                          children: [`₦`, t.price.toLocaleString(`en-NG`)],
                        }),
                      }),
                    ],
                  },
            ...
            (0, j.jsx)(`button`, {
              ...
              children: a
                ? (0, j.jsx)(mr, { className: `animate-spin w-5 h-5` })
                : `Buy Now`,
            }),
          ],
        }),
  ...
  Vr = () => {
    let e = (0, _.useRef)(null),
      ...
      r = () => {
        let t = e.current;
        t && (t.paused ? (t.play(), n(!0)) : (t.pause(), n(!1)));
      };
    return (0, j.jsxs)(`div`, {
      className: ` md:max-w-2xl mx-auto px-5 py-16 flex flex-col items-center gap-10`,
      children: [
        (0, j.jsxs)(`div`, {
          className: `w-full relative rounded-2xl overflow-hidden bg-[#111] aspect-video cursor-pointer group`,
          children: [
            (0, j.jsx)(`video`, {
              ref: e,
            ...
            (0, j.jsxs)(`div`, {
              className: `absolute top-0 left-0 right-0 px-4 py-3 bg-gradient-to-b from-black/60 to-transparent flex items-center gap-3`,
              children: [
                (0, j.jsx)(`div`, {
                  className: `w-9 h-9 rounded-full bg-white flex-shrink-0 flex items-center justify-center`,
                  children: (0, j.jsxs)(`svg`, {
                    className: `w-4 h-4 fill-[#1a1a1a]`,
                    viewBox: `0 0 24 24`,
                    children: [
                ...
                (0, j.jsxs)(`div`, {
                  children: [
                    (0, j.jsx)(`p`, {
                      ...
                      children: `The Story Behind Too Clean`,
                    }),
                    (0, j.jsx)(`span`, {
              ...
              (0, j.jsx)(`div`, {
                ...
                children: (0, j.jsx)(`div`, {
                  ...
                  children: (0, j.jsx)(`svg`, {
                    className: `w-6 h-6 fill-[#1a1a1a] ml-1`,
                    viewBox: `0 0 24 24`,
            ...
            t &&
              (0, j.jsx)(`div`, { onClick: r, className: `absolute inset-0` }),
          ],
        }),
        (0, j.jsx)(`p`, {
          className: `text-center text-[15px] text-[#555] leading-relaxed max-w-lg`,
          children: `Too Clean was created with one mission: to provide real solutions for your hairline. Every formula is crafted with purpose, so you can feel confident, daily.`,
        }),
      ],
    });
  },
  Hr = `w-full border border-[#ddd] rounded-lg px-3.5 py-2.5 text-[14px] text-[#1a1a1a] placeholder:text-[#bbb] outline-none focus:border-[#1a1a1a] transition-colors bg-white`,
  Ur = () => {
    let { id: e } = ht(),
      [t, n] = (0, _.useState)(),
    ...
    return (0, j.jsxs)(`div`, {
      className: `flex flex-col md:grid md:grid-cols-2 md:h-full`,
      children: [
        (0, j.jsxs)(`div`, {
          className: `px-6 md:px-10 py-10 md:h-full border-b md:border-b-0 md:border-r border-[#e8e8e8]`,
          children: [
            (0, j.jsx)(`p`, {
              className: `text-[18px] font-black text-[#1a1a1a] tracking-tight mb-8`,
              children: `Too Clean`,
            }),
            (0, j.jsxs)(`div`, {
              className: `mb-7`,
              children: [
                (0, j.jsx)(`h3`, {
                  className: `text-[15px] font-bold text-[#1a1a1a] mb-3`,
                  children: `Contact`,
                }),
                (0, j.jsxs)(`div`, {
                  ...
                  children: [
                    (0, j.jsxs)(`select`, {
                      ...
                      children: [
                        ...
                        (0, j.jsx)(`option`, { children: `Lagos` }),
                        (0, j.jsx)(`option`, { children: `Abuja` }),
                        (0, j.jsx)(`option`, { children: `Rivers` }),
                        (0, j.jsx)(`option`, { children: `Kano` }),
                        (0, j.jsx)(`option`, { children: `Oyo` }),
                      ],
                    }),
                    (0, j.jsxs)(`div`, {
            ...
            (0, j.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, j.jsx)(`p`, {
                  className: `text-[12px] text-[#888] mb-3`,
                  children: `All transactions are secure and encrypted.`,
                }),
                (0, j.jsxs)(`div`, {
                  className: `border-2 border-[#1a1a1a] rounded-lg px-4 py-3 flex items-center gap-3 bg-[#fafafa]`,
                  children: [
                    (0, j.jsx)(`div`, {
                      className: `w-[18px] h-[18px] rounded-full border-2 border-[#1a1a1a] flex-shrink-0 flex items-center justify-center`,
                      children: (0, j.jsx)(`div`, {
                        className: `w-2.5 h-2.5 rounded-full bg-[#1a1a1a]`,
                      }),
                    }),
                    (0, j.jsx)(`span`, {
                      ...
                      children: `Pay with Paystack — Bank Transfer`,
                    }),
                  ],
                }),
              ],
            ...
            (0, j.jsxs)(`div`, {
              className: `flex items-center justify-center gap-1.5 mt-4 text-[12px] text-[#aaa]`,
              children: [
                (0, j.jsx)(hr, { size: 12 }),
        ...
        (0, j.jsxs)(`div`, {
          className: `px-6 md:px-10 py-10 md: bg-[#f7f7f5]`,
          children: [
            (0, j.jsx)(`h3`, {
              className: `text-[15px] font-bold text-[#1a1a1a] mb-5`,
                  ...
                  children: [
                    (0, j.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, j.jsx)(`div`, {
                          className: `absolute -top-1.5 -right-1.5 w-5 h-5 bg-[#555] text-white text-[10px] font-bold rounded-full flex items-center justify-center`,
                          children: t?.qty,
                        }),
                      ],
                    }),
                    ...
                    (0, j.jsx)(`div`, {
                      ...
                      children: (0, j.jsxs)(`p`, {
                        ...
                        children: [`₦`, t.total.toLocaleString(`en-NG`)],
                      }),
                    }),
                  ],
                }),
            }),
            (0, j.jsx)(`div`, { className: `h-px bg-[#e8e8e8] mb-4` }),
            (0, j.jsxs)(`div`, {
              className: `flex justify-between text-[14px] text-[#555] mb-2.5`,
              children: [
                (0, j.jsx)(`span`, { children: `Shipping` }),
                (0, j.jsx)(`span`, {
            ...
            (0, j.jsx)(`div`, { className: `h-px bg-[#e8e8e8] my-3` }),
            (0, j.jsxs)(`div`, {
              className: `flex justify-between text-[17px] font-extrabold text-[#1a1a1a]`,
              children: [
  ...
  Wr = `w-full border-[1.5px] border-[#ddd] rounded-lg px-3.5 py-2.5 text-[14px] text-[#1a1a1a] placeholder:text-[#ccc] outline-none focus:border-[#1a1a1a] transition-colors`,
  Gr = `bg-[#1a1a1a] text-white text-[12px] font-bold tracking-[0.05em] uppercase px-6 py-3 rounded-lg hover:opacity-80 transition-opacity mt-1`,
  Kr = () => {
    let [e, t] = (0, _.useState)(``),
      [n, r] = (0, _.useState)(``),
      [i, a] = (0, _.useState)(``);
    return (0, j.jsxs)(`div`, {
      className: `max-w-2xl mx-auto px-5 py-14`,
      children: [
        (0, j.jsx)(`h1`, {
          className: `text-4xl font-black text-[#1a1a1a] tracking-tight mb-7`,
          children: `Track Your Order`,
        ...
        (0, j.jsx)(`div`, {
          ...
          children: (0, j.jsxs)(`div`, {
            ...
            children: [
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  (0, j.jsxs)(`div`, {
                    children: [
                      (0, j.jsx)(`label`, {
                        className: `block text-[11px] font-bold tracking-[0.06em] uppercase text-[#555] mb-2`,
                  ...
                  (0, j.jsx)(`button`, {
                    onClick: () => {
                      console.log(`Track by order:`, e, n);
                    },
                    className: Gr,
                    children: `Track`,
                  }),
              ...
              (0, j.jsxs)(`div`, {
                className: `flex md:flex-col items-center justify-center gap-2 py-4 md:py-0 md:px-8`,
                children: [
                  (0, j.jsx)(`div`, {
                    className: `flex-1 md:w-px md:flex-none md:h-full w-full h-px bg-[#e8e8e8]`,
                  }),
                  (0, j.jsx)(`span`, {
              ...
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, j.jsx)(`button`, {
                    onClick: () => {
                      console.log(`Track by tracking number:`, i);
                    },
                    className: Gr,
                    children: `Track`,
                  }),
  ...
  qr = () => {
    let e = dt(),
      t = () => {
        (localStorage.removeItem(`adminToken`), e(`/admin/login`));
      },
      n = ({
        isActive: e,
      }) => `text-[11px] font-bold tracking-[0.06em] uppercase px-4 py-2 rounded-md transition-all
    ${e ? `text-white bg-white/12` : `text-white/50 hover:text-white hover:bg-white/8`}`;
    return (0, j.jsxs)(`div`, {
      className: `min-h-screen bg-[#f7f7f5]`,
      children: [
        (0, j.jsxs)(`nav`, {
          className: `bg-[#1a1a1a] h-[52px] flex items-center justify-between px-6 sticky top-0 z-50`,
          children: [
            (0, j.jsxs)(`div`, {
              className: `flex items-center gap-1`,
              children: [
                (0, j.jsx)(`span`, {
                  className: `text-white font-black text-[15px] mr-5`,
                  children: `Too Clean — Admin`,
                }),
                (0, j.jsx)(Mn, {
                  to: `/admin/dashboard`,
                  className: n,
            ...
            (0, j.jsxs)(`div`, {
              ...
              children: [
                (0, j.jsxs)(`div`, {
                  className: `flex items-center gap-2 text-white/60 text-[12px]`,
                  children: [
                    (0, j.jsx)(`div`, {
                      className: `w-7 h-7 rounded-full bg-[#453224] flex items-center justify-center text-white text-[11px] font-bold`,
                      children: `AD`,
                    }),
                    `Admin`,
                  ],
        ...
        (0, j.jsx)(`main`, { className: `p-6`, children: (0, j.jsx)(Rt, {}) }),
      ],
    });
  },
  Jr = [
  ...
  Zr = () =>
    (0, j.jsxs)(`div`, {
      children: [
        (0, j.jsx)(`h1`, {
          className: `text-xl font-black text-[#1a1a1a] mb-5`,
          children: `Dashboard`,
        }),
        (0, j.jsx)(`div`, {
          ...
          children: Jr.map((e) =>
            (0, j.jsxs)(
              `div`,
              {
                ...
                children: [
                  (0, j.jsx)(`p`, {
                    className: `text-[11px] font-bold uppercase tracking-[0.06em] text-[#888] mb-2`,
                    children: e.label,
                  }),
                  (0, j.jsx)(`p`, {
                  ...
                  (0, j.jsx)(`p`, {
                    className: `text-[11px] mt-1 ${e.subColor}`,
                    children: e.sub,
                  }),
                ],
              },
        ...
        (0, j.jsxs)(`div`, {
          ...
          children: [
            (0, j.jsx)(`div`, {
              className: `px-5 py-3.5 border-b border-[#e8e8e8] flex items-center justify-between`,
              children: (0, j.jsx)(`p`, {
                      ...
                      `tr`,
                      {
                        ...
                        children: [
                          ...
                          (0, j.jsx)(`td`, {
                            className: `px-5 py-3`,
                            children: (0, j.jsx)(`span`, {
                              className: `text-[10px] font-bold uppercase px-2 py-1 rounded ${Xr[e.status]}`,
                              children: e.status,
                            }),
                          }),
                        ],
  ...
  Qr = () => {
    ...
    return (0, j.jsxs)(`div`, {
      children: [
        ...
        e &&
          (0, j.jsxs)(`div`, {
            className: `bg-white border border-[#e8e8e8] rounded-xl mb-5 overflow-hidden`,
            children: [
              (0, j.jsx)(`div`, {
                className: `px-5 py-3.5 border-b border-[#e8e8e8]`,
                children: (0, j.jsx)(`p`, {
                  className: `text-[13px] font-bold`,
              ...
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  (0, j.jsxs)(`div`, {
                    children: [
                      (0, j.jsx)(`label`, {
                        className: `block text-[11px] font-bold uppercase tracking-[0.06em] text-[#555] mb-1.5`,
                  ...
                  (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, j.jsxs)(`div`, {
                        className: `border-[1.5px] border-dashed border-[#ddd] rounded-lg p-6 text-center hover:border-[#1a1a1a] transition-colors cursor-pointer`,
                        children: [
                          (0, j.jsx)(`p`, {
                          ...
                          (0, j.jsx)(`p`, {
                            ...
                            children: `PNG, JPG, WEBP — max 5MB each`,
                          }),
                          (0, j.jsx)(`input`, {
                            type: `file`,
                            multiple: !0,
              ...
              (0, j.jsxs)(`div`, {
                className: `px-5 py-3.5 border-t border-[#e8e8e8] flex justify-end gap-2`,
                children: [
                  (0, j.jsx)(`button`, {
                    onClick: () => t(!1),
          ...
          children: [
            ...
            (0, j.jsxs)(`table`, {
              ...
              children: [
                ...
                (0, j.jsx)(`tbody`, {
                  children: [
                    `Hairline Spray — Black`,
                    `Hairline Spray — Brown`,
                  ].map((e) =>
                    (0, j.jsxs)(
                      `tr`,
                      {
                        ...
                        children: [
                          (0, j.jsx)(`td`, {
                            className: `px-5 py-3`,
                            children: (0, j.jsx)(`div`, {
                              className: `w-9 h-9 bg-[#f5f0e8] rounded-lg`,
                            }),
                          }),
                          (0, j.jsx)(`td`, {
                            className: `px-5 py-3 text-[13px] font-semibold`,
                          ...
                          (0, j.jsx)(`td`, {
                            className: `px-5 py-3 text-[13px] text-[#888]`,
                            children: `Apr 10, 2026`,
                          }),
                          (0, j.jsx)(`td`, {
                            className: `px-5 py-3`,
                            children: (0, j.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, j.jsx)(`button`, {
                                  className: `text-[11px] font-bold px-3 py-1.5 bg-[#e24b4a] text-white rounded-md hover:opacity-80`,
                                  children: `Delete`,
                                }),
                              ],
                            }),
          ...
          children: [
            (0, j.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, j.jsx)(`div`, {
                  className: `px-5 py-3.5 border-t border-[#e8e8e8] flex justify-end`,
  ...
  ei = () => {
    ...
    let u = `w-full border-[1.5px] border-[#e0e0e0] rounded-lg px-3.5 py-2.5 text-[14px] text-[#1a1a1a] placeholder:text-[#ccc] outline-none focus:border-[#1a1a1a] transition-colors`;
    return (0, j.jsx)(`div`, {
      className: `h-full bg-[#f7f7f5] flex items-center justify-center px-5`,
      children: (0, j.jsxs)(`div`, {
        ...
        children: [
          (0, j.jsxs)(`div`, {
            ...
            children: [
              (0, j.jsx)(`div`, {
                className: `w-11 h-11 bg-[#1a1a1a] rounded-xl flex items-center justify-center mb-3`,
                children: (0, j.jsxs)(`svg`, {
          ...
          (0, j.jsxs)(`form`, {
            ...
            children: [
              (0, j.jsx)(`h2`, {
                className: `text-[18px] font-black text-[#1a1a1a] mb-1`,
                children: `Welcome back`,
              }),
              (0, j.jsx)(`p`, {
                className: `text-[13px] text-[#888] mb-6`,
                children: `Sign in to your admin account`,
              }),
              o &&
                (0, j.jsx)(`div`, {
                  className: `bg-[#fcebeb] border border-[#f09595] rounded-lg px-4 py-2.5 text-[13px] text-[#791f1f] mb-5`,
                  children: o,
                }),
              (0, j.jsxs)(`div`, {
                className: `mb-4`,
                children: [
                  (0, j.jsx)(`label`, {
                    className: `block text-[11px] font-bold uppercase tracking-[0.07em] text-[#555] mb-1.5`,
                    children: `Email`,
                  }),
                  (0, j.jsx)(`input`, {
                    type: `email`,
          ...
          (0, j.jsxs)(Bt, {
            children: [
              (0, j.jsxs)(A, {
                element: (0, j.jsx)(wr, {}),
                children: [
                  (0, j.jsx)(A, { path: `/`, element: (0, j.jsx)(Lr, {}) }),
                  (0, j.jsx)(A, {
                    path: `/product/:id`,
                    element: (0, j.jsx)(Br, {}),
                  }),
